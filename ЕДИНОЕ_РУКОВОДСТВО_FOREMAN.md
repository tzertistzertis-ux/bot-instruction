...
| Проверка через Kaspersky OpenTIP | Отправляет хеш файла, а при необходимости сам файл во внешний антивирусный API Касперского | Помогает поймать известные угрозы без установки тяжелого антивируса на тариф Amvera |
