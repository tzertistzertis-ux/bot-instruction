...
| Visual regression веб-интерфейса Foreman | Внешний вид важных экранов: карточки, кнопки, ошибки и мобильный вид не должны “поехать” | 2 визуальных автотеста |
...
| Полная регрессия Telegram-бота (`full`) | Команды, рендер, golden-проверки, старые сценарии, защита от регрессий | 1605 автотестов плюс render/golden-проверки |
| PostgreSQL integration на локальной базе | Startup migrations, readiness, login, несовместимая схема | 3 интеграционных автотеста |
