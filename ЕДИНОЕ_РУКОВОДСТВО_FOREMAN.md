...
| Тесты мобильного приложения | Экраны, маршруты, кэш заявок, заявки на заполнения/расходники, защищенное хранение офлайн-черновиков и очереди отправки, проверка безопасного обновления APK и совместимость с backend | 80 автотестов |
...
Текущая версия в исходниках: `0.2.102+6103`.
