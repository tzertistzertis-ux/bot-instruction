...
### 1.14.5 Примечание внутри карточки
...
### 1.14.7 Статусы и права доступа
...
### 1.14.8 Перетаскивание карточек
...
### 1.14.9 Почему это лучше обычной таблицы
...
### 1.14.10 Что делать, если изменение не сохраняется
