...
1. Сборку `foreman-api`.
2. Регрессионное ядро backend.
3. Python-тесты Telegram/Foreman request-layer.
4. Базовый smoke веб-интерфейса.
5. Анализ мобильного приложения.
6. Тесты мобильного приложения.
