...
| **Foreman сейчас** | **760-820** | Веб, мобильное приложение и Telegram-бот имеют несколько слоев защиты: серверные роли, гостевые ограничения, proxy-allowlist, антивирусный контур, контроль опасных форматов, журналы безопасности, управляемые Web Push-оповещения, регрессии, мегатест и мегатест-2 |
...
|:---|:---|:---|:---|
| Foreman Web в браузере | 770-825 | Авторизация, серверные роли, защита гостя, лимиты скачивания, журнал безопасности, proxy-allowlist, антивирусный контур, запрет опасных вложений, профильные Web Push-подписки, админские правила push-событий, UI/visual-регрессии | Ужесточить CSP без `unsafe-inline`, добавить внешний WAF/anti-DDoS и независимый пентест |
| Telegram-бот и claim-bot | 770-835 | Проверка ролей, безопасные команды, quarantine/risk-gate файлов, ALARM-письма при вирусах, push по важным почтовым событиям, proxy-allowlist, диагностика, тесты полного regression-контура | Добавить более формальный мониторинг алертов и регулярный внешний аудит |
