...
Итого в последнем успешном прогоне `мегатеста-2` прошло примерно 1876 автопроверок, плюс 2 отдельных backend regression-скрипта и render/golden-проверки бота. Это не замена обычного мега-теста, а дополнительный слой для рискованных изменений.
...
| Антивирусный контур файлов | Проверка безопасного сохранения, строгая трактовка ответов Kaspersky, аудит-журнал без секретов, Telegram-просмотр последних проверок и заблокированных файлов, ALARM-письма участникам опасного письма, показ карантинной улики в Foreman |
