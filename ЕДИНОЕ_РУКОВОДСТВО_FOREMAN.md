...
| **Foreman сейчас** | **750-810** | Веб, мобильное приложение и Telegram-бот имеют несколько рабочих слоев защиты: серверные роли, гостевые ограничения, proxy-allowlist, антивирусный контур, контроль опасных форматов, журналы безопасности, осторожный honeypot/bot-defense на входе, HttpOnly cookie-сессию для веба, защиту rate-limit от простой подмены forwarding-заголовков, TOTP/MFA для веб-входа, известные устройства в audit-контуре, наблюдение риск-сигналов входа, управляемые Web Push-оповещения, регрессии, мегатест и мегатест-2. Диапазон повышен честно и умеренно: оценка опирается только на реально внедренные меры, а не на обещания будущего аудита |
| Зрелая строительная SaaS/ECM-система | 820-900 | Обычно добавлены отдельные security-процессы, корпоративный мониторинг, внешние проверки, независимый пентест, корпоративный SSO, централизованное управление MFA, договорные SLA и регулярные аудиты |
