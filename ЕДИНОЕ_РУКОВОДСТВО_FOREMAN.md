...
Что изменено в редакции 3: для Foreman Mobile зафиксированы версия мобильного релиза `0.2.105+6106`, управление доверенными мобильными устройствами, привязка мобильных сессий к экземпляру Foreman Mobile на конкретном смартфоне, возможность заблокировать доступ мобильного приложения на потерянном смартфоне сотрудника без блокировки самого сотрудника, APK obfuscation, подписанный манифест обновления `app-update.json.sig`, проверка подписи манифеста перед SHA-256 скачанного APK, а также обновлены честные оценки безопасности и количество актуальных тестов.
