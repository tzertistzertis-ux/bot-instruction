...
| **Foreman сейчас** | **750-800** | Веб, мобильное приложение и Telegram-бот имеют несколько рабочих слоев защиты: серверные роли, гостевые ограничения, proxy-allowlist, антивирусный контур, контроль опасных форматов, журналы безопасности, осторожный honeypot/bot-defense на входе, HttpOnly cookie-сессию для веба, защиту rate-limit от простой подмены forwarding-заголовков, TOTP/MFA для веб-входа и мобильного админского входа, расширенный цифровой слепок браузера, доверенные устройства и наблюдение риск-сигналов входа в audit-контуре, управляемые Web Push-оповещения, мобильную APK-сборку с obfuscation, проверку подписи манифеста обновления и SHA-256 APK, корректный Android install-flow обновления, anti-tamper сигналы root/debug/Frida, управление доверенными мобильными устройствами, безопасное отключение доступа сотрудника с отзывом web/mobile-сессий и блокировкой мобильных устройств, регрессии, мегатест и мегатест-2. Диапазон оставлен строгим перед сторонним аудитом: оценка опирается только на реально внедренные меры, не включает будущие обещания и не приравнивает внутренний рабочий сервис к зрелой промышленной SaaS/ECM-платформе |
