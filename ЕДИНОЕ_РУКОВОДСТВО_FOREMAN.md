...
| Дополнительные backend regression-скрипты | Хранение документов, обновление данных, input/render-логика, XSS/security-render для файлов | 3 отдельных regression-скрипта |
...
Backend mutation pilot summary: killed=29 survived=0 total=29
```
