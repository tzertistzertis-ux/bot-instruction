...
function labelForHeading(text, level) {
  ...
  if (/postgresql|безопасность|антивирус|проверяет файлы|ocr|office-converter|читает заявки|проверяется перед выпуском|мега-тест|мегатест|устойчивость|качества защитных тестов|покрыта тестами|ручного клика|ограничение/.test(t)) {
