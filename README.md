...
YandexGPT в текущем коде включен **не глобально на все команды**, а в двух контролируемых контурах:

- `LLM_SCOPE: consumables_parser + safe_intent_router` (это видно и в `/status`);
